...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // DONE: Chamar o método SaveChanges do _context para salvar no Banco SQL
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // DONE: As propriedades estão incompletas
        ...
        // DOME: Chamar o método de Update do _context.Funcionarios para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // DONE: Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL
